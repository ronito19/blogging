...
export class AppComponent {
  ...
  newList: INews[] = [
    ...
    {
      title: '¡Increíble! Se ha batido el récord mundial de Super Mario Bros., un jugador ha logrado lo imposible',
    ...
    {
      title: 'El asteroide 2024 YR4 podría chocar con la Tierra en 7 años. ',
